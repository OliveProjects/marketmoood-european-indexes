...
Fetches intraday (1m/1d) and weekly (60m/5d) for European stock indexes.
"""
...
def main():
    ...
    print(f"=== fetch_fast.py (european-indexes)  {ts} ===")
    ...
    save("data/european-intraday.json", {"fetched_at": now_ms, "assets": intraday})
    save("data/european-weekly.json",   {"fetched_at": now_ms, "assets": weekly})
